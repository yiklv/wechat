...
Page({
  ...
  onShareAppMessage: function () {
    ...
    var title = "分享“" + config.getWebsiteName +"”";
    var path =""
            ...
            self.setData({
                ...
                postsList: self.data.postsList.concat(response.data.map(function (item) {
                    ...
                    if (item.category_name != null) {
                        ...
                        item.categoryImage = "../../images/src/topic.png";
                    }
                    else {
                        item.categoryImage = "";
                    }
                    ...
                    if (item.post_thumbnail_image == null || item.post_thumbnail_image == '') {
                      item.post_thumbnail_image = '../../images/src/post_default_img.jpg';
                    }
  ...
  fetchCategoriesData: function (id) {
    ...
    getCategoryRequest.then(response =>{
        ...
        if (typeof (response.data.category_thumbnail_image) == "undefined" || response.data.category_thumbnail_image == "") {
          catImage = "../../images/src/post_default_img.jpg";
        }
        else {
